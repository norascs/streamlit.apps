...
def summarize_text_groq(transcription):
    try:
...
def summarize_youtube_video(video_url):
    ...
    if transcript:
        ...
        return summarize_text_groq(transcript)
    else:
        st.error("No suitable captions found for this video.")
        return None

st.title("YouTube Video Summarizer")
video_url = st.text_input("YouTube Video URL", "https://www.youtube.com/watch?v=zdbVtZIn9IM&t=3s&ab_channel=DwarkeshPatel")
